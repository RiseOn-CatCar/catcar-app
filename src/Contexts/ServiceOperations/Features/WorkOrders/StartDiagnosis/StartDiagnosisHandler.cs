...
public static class StartDiagnosisHandler
{
    public static async Task<Upshot<string>> Handle(StartDiagnosisCommand command, IValidator<StartDiagnosisCommand> validator, IWorkOrderRepository repository, IDbContextOutbox<ServiceOperationsDbContext> outbox, CancellationToken cancellationToken)
    {
        ...
        var transition = workOrder.StartDiagnosis();
